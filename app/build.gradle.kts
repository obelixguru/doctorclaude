...
dependencies {
    ...
    // Health Connect — optional heart-rate / steps (needs a wearable + the Health Connect app).
    implementation(libs.androidx.health.connect)

    // In-app camera for the product scan (reliable, asks CAMERA permission itself).
